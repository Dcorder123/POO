...
bool Save::salvarDados(vector<App*> apps, vector<Producao*> producoes, vector<Ator> atores, vector<Diretor> diretores, vector<SmartTV> smartTVs)
{
    ofstream arquivo;
    arquivo.open("dados1.txt", ios::out);
    if(arquivo.is_open())
    {
...
bool Save::carregarDados()
{
    ifstream arquivo;
    arquivo.open("dados1.txt", ios::in);
    cout << endl;
